...
Интерфейс поддерживает светлую и тёмную тему macOS. Непрозрачный фон панели сохраняет
контраст независимо от окон позади. При сохранении, назначении запроса и объединении
задач появляется индикатор операции; действия заблокированы до пересчёта статистики.
